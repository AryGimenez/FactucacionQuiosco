...
import Precentacion.CompararString;
import Precentacion.CompararStringAcendente;
import Precentacion.CompararStringDesendente;
 ...
 * @author ary
 */
public class PersonalListModel <T> extends AbstractListModel implements Observer{
     ...
     */
    public PersonalListModel(short Oreden, Observable ObjObsevador) {
     ...
     */
    public PersonalListModel( T items[], short Oreden, Observable ObjObsevador) {
     ...
     */
    public PersonalListModel(AbstractCollection<T> v, short Oreden, Observable ObjObsevador) {
